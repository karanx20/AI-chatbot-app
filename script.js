 ...
 // API setup
 const API_KEY = "AIzaSyAD7J7DdoohrnQ3ZkZlortEjVsxRIi1oDk";
 ...
 const handleOutgoingMessage = (e) => {
    ...
    outgoingMessageDiv.querySelector(".message_text").innerText = userData.message;
    chatBody.appendChild(outgoingMessageDiv);
    chatBody.scrollTo({ top: chatBody.scrollHeight, behavior: "smooth" });
  
    // Stimulate bot reponse with thinking indicator after a delay
    setTimeout(() => {
        const messageContent = `<svg class="bot_avatar" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 1024 1024">
                <path
...
document.querySelector(".chat_form").appendChild(picker);
 ...
 ("show_chatbot"));
 closeChatbot.addEventListener("click", () => document.body.classList.remove("show_chatbot"));